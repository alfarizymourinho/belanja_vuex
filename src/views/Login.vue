<template>
    ...
    <div class="flex items-center justify-center min-h-screen bg-gray-100" style="background-color: silver;">
        <div class="px-8 py-6 mx-4 mt-20 text-left bg-white shadow-lg md:w-1/3 lg:w-1/3 sm:w-1/" style="background-color: gray;">
            ...
            <h3 class="text-2xl font-bold text-center">ALMG Store</h3>
            <form action="" @submit.prevent="performLogin">
                <div class="mt-4">
                    <div>
                        <label class="block" for="Name">Username</label>
                        <input type="text" placeholder="Your Name" v-model="email" id="email"
                            class="w-full px-4 py-2 mt-2 border rounded-md focus:outline-none focus:ring-1 focus:ring-blue-600">
                    </div>
                    <div class="mt-4">
                        <label class="block">Password</label>
                        <input type="password" placeholder="Your Password" v-model="password" id="password"
                            class="w-full px-4 py-2 mt-2 border rounded-md focus:outline-none focus:ring-1 focus:ring-blue-600">
                    </div>
